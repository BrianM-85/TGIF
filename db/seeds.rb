...
muppets_tonight = Show.create(name: "Muppets Tonight", description: "Kermit the Frog, Clifford and friends struggle to put on a weekly TV variety show.", image_url: "/images/Muppets Tonight Logo.jpg")
aliens = Show.create(name: "Aliens in the Family", description: "Doug Brody is kidnapped by an alien mom named Cookie. They marry and hilariously try to blend their blended family into everyday life. The aliens were puppets designed by Jim Henson's Creature Shop.", image_url: "/images/Aliens Logo.jpg")
sabrina = Show.create(name: "Sabrina the Teenage Witch", description: "Sabrina is a normal teenager, except for one thing -- she's a witch! Guided by her aunts, who come from a long line of witches, and Salem, a mischievous warlock doing penance as a black cat, Sabrina continually struggles to harness her powers while wittingly wreaking havoc on friends and foes alike. While struggling through the growing pains associated with being a witch and getting into lots of harmless trouble along the way, Sabrina realizes that magic is not quite as easy as pointing your finger.", image_url: "/images/Sabrina Logo.jpg")
clueless = Show.create(name: "Clueless", description: "A follow-up to the blockbuster movie of the same name, following the rich teenager Cher and her friends as they attend high school in Beverly Hills.", image_url: "/images/Clueless Logo.jpg")
you_wish = Show.create(name: "You Wish", description: "A single mother reluctantly accepts the services of a genie, who's been imprisoned in a magic carpet for two thousand years.", image_url: "/images/You Wish Logo.jpg")
teen_angel = Show.create(name: "Teen Angel", description: "After eating a six-month-old hamburger, Marty DePolo dies and God's Cousin Rod appoints him as his best friend's guardian angel.", image_url: "/images/Teen Angel Logo.jpg")
two_of_a_kind = Show.create(name: "Two of a Kind", description: "A show about a single father who has his hands full raising twin sisters Mary-Kate and Ashley.", image_url: "/images/Two of a Kind Logo.jpg")
pizza_place = Show.create(name: "Two Guys, a Girl, and a Pizza Place", description: "Three twenty-somethings share a Boston apartment and hang around (and work) at a pizza place.", image_url: "/images/Two Guys Logo.jpg")
brothers_keeper = Show.create(name: "Brother's Keeper", description: "The series centers around Porter Waide, a milquetoast college History professor and widowed single father, raising his son, Oscar, by himself until his brother, Bobby, a football placekicker who had just been signed to play with the San Francisco 49ers and has a reputation for being a bad boy, moves in with his brother and nephew, as part of a stipulation in his new multimillion-dollar contract in which Bobby has to live with someone who is more responsible than him, in order to change his troublemaking ways.", image_url: "/images/Brothers Keeper Logo.jpg")
the_hughleys = Show.create(name: "The Hughley's", description: "Darryl Hughley, who owns his own vending machine business, moving out of from South Central to West Hills, a predominately white neighborhood within the San Fernando Valley. Darryl and his family try to adjust to living in an all-white area, at the same time trying to not forget who they are and where they came from.", image_url: "/images/Hughleys Logo.jpg")
